...
- [GitHub releases](https://github.com/clandro/clandro-create-package/releases).
##
...
The deb file can also be added to a custom apt repository created with [`clandro-apt-repo`](https://github.com/clandro/clandro-apt-repo) or any other available tool.
##



[Clandro App]: https://github.com/clandro/clandro-app
