...
- Add support to automatically add `clandro-create-package` script and `sha256sums.txt` to releases.
...
### Fixed
- Fixed version in `setup.py`. ([`289ebc4f`](https://github.com/agnostic-apollo/clandro-create-package/commit/289ebc4f))
...
### Added
- Allow for folders and symlinks in package ([`#15`](https://github.com/cl-andro/clandro-create-package/pull/15)).


## [v0.5] - 2018-10-30

### Changed
- Create `./control` instead of control in tar ([`#14`](https://github.com/cl-andro/clandro-create-package/pull/14)).
...
[unreleased]: https://github.com/cl-andro/clandro-create-package/compare/v0.12.0...HEAD
[v0.12.0]: https://github.com/cl-andro/clandro-create-package/compare/v0.11...v0.12.0
[v0.11]: https://github.com/cl-andro/clandro-create-package/compare/v0.10...v0.11
[v0.10]: https://github.com/cl-andro/clandro-create-package/compare/v0.9...v0.10
[v0.9]: https://github.com/cl-andro/clandro-create-package/compare/v0.8...v0.9
[v0.8]: https://github.com/cl-andro/clandro-create-package/compare/v0.7...v0.8
[v0.7]: https://github.com/cl-andro/clandro-create-package/releases/tag/v0.7
[v0.6]: https://github.com/cl-andro/clandro-create-package/releases/tag/v0.6
[v0.5]: https://github.com/cl-andro/clandro-create-package/releases/tag/v0.5
[v0.4]: https://github.com/cl-andro/clandro-create-package/releases/tag/v0.4
[v0.3]: https://github.com/cl-andro/clandro-create-package/releases/tag/v0.3
[v0.2]: https://github.com/cl-andro/clandro-create-package/releases/tag/v0.2
