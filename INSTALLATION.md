...
- Android users should install [Clandro App](https://github.com/cl-andro/clandro-app).
...
curl -L 'https://github.com/cl-andro/clandro-create-package/releases/latest/download/clandro-create-package' -o "$install_path/clandro-create-package" && \
...
2. Download the `clandro-create-package` file.  
    ...
    - Download to install directory directly from github using `curl` using a non-root clandro shell.  
        ...
        - Specific release:  
          ...
          `curl -L 'https://github.com/cl-andro/clandro-create-package/releases/download/v0.12.0/clandro-create-package' -o "$install_path/clandro-create-package"`  

        - Master Branch *may be unstable*:  

          `curl -L 'https://github.com/cl-andro/clandro-create-package/raw/master/src/clandro-create-package' -o "$install_path/clandro-create-package"`  
...
sudo curl -L 'https://github.com/cl-andro/clandro-create-package/releases/latest/download/clandro-create-package' -o "$install_path/clandro-create-package" && \
...
2. Download the `clandro-create-package` file.  
    ...
    - Download to install directory directly from github using `curl` using a root shell with `sudo`.  
        ...
        - Specific release:  
          ...
          `sudo curl -L 'https://github.com/cl-andro/clandro-create-package/releases/download/v0.12.0/clandro-create-package' -o "$install_path/clandro-create-package"`  

        - Master Branch *may be unstable*:  

          `sudo curl -L 'https://github.com/cl-andro/clandro-create-package/raw/master/src/clandro-create-package' -o "$install_path/clandro-create-package"`  
